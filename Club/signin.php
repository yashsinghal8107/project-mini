...
if (isset($_POST['submit']))
{
	...
	if ($num==1)
	{
		...
		$mess = "You have entered wrong username or password";
	}
}
?>
<!DOCTYPE html>
...
<body>
			...
			<form action="signin.php" class="container" method="post">
				<h1>Club Login</h1>
				...
				<?php if (isset($mess)) {
				echo '<label style="color:red; font-size:12px;">'.$mess.'</label><br>';
				}
				?>
